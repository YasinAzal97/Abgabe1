...
// nullish coalescing
const database = dbConfigEnv.name ?? Magazin.name.toLowerCase();
...
const username = dbConfigEnv.username ?? Magazin.name.toLowerCase();
...
export const typeOrmModuleOptions: TypeOrmModuleOptions =
    dbType === 'postgres'
        ? {
              ...
              password: pass,
              database,
              // siehe auch src\magazin\magazin.module.ts
              entities: [Magazin, Schlagwort],
