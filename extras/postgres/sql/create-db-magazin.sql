...
-- (4) chown postgres:postgres /var/lib/postgresql/tablespace/magazin
-- (5) exit
-- (6) docker compose down
-- (7) in docker-compose.yaml den User "postgres" wieder aktivieren
-- (8) docker compose up
-- (9) docker compose exec postgres bash
-- (10) psql --dbname=postgres --username=postgres --file=/sql/create-db-magazin.sql
-- (11) exit

-- https://www.postgresql.org/docs/current/sql-createrole.html
CREATE ROLE magazin LOGIN PASSWORD 'p';

-- https://www.postgresql.org/docs/current/sql-createdatabase.html
CREATE DATABASE magazin;

GRANT ALL ON DATABASE magazin TO magazin;

-- https://www.postgresql.org/docs/10/sql-createtablespace.html
CREATE TABLESPACE magazinspace OWNER magazin LOCATION '/var/lib/postgresql/tablespace/magazin';
